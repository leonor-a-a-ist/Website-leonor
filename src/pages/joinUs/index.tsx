...
const normalTextSize =
  "text-[3.7vw] sm:text-[2.5vw] md:text-[1.7vw] lg:text-[1.3vw] 2xl:text-[1vw]";
  ...
  return (
    <>
      ...
      <MyDefaultPage>
          ...
          <div className="w-full max-w-[85vw] 2xl:max-w-[80vw]">
            <div className="flex flex-col xl:flex-row gap-10">
              ...
              <div className="xl:w-2/5 flex flex-col justify-center">
                ...
                <p className={`mt-6 ${normalTextSize} text-gray-300 leading-relaxed text-justify`}>
                  {t.info}
                </p>
              ...
              <div className="xl:w-3/5">
                <div className="rounded-2xl bg-[#16263c]/70 border border-[#39a6ff]/25 shadow-lg shadow-black/30 backdrop-blur-sm p-5 shadow-xl h-full">
                  ...
                  <div className="mt-2 space-y-8">
                    ...
                    <div>
                      ...
                      <p className={`mt-2 ${normalTextSize} text-gray-300 text-justify`}>
                        {t.period}
                      </p>
                    </div>
        ...
        <div className="w-full max-w-[85%] mx-auto mt-[15vh]">
          <div className="h-px w-full bg-white/15 mb-[3vh]" />
          <FAQ />

          <div className="flex flex-col items-center mt-[10vh] mb-[20vh]">
            <h3 className={`${h3Size} font-bold text-white text-center`}>Still have questions?</h3>

            <p className={`${normalTextSize} mt-4 max-w-4xl text-center text-gray-300`}>
              {t.questions}
            </p>

            <TransitionLink
              href="/contacts"
              className="mt-8 inline-flex items-center rounded-xl bg-blue-600 px-7 py-3 font-semibold text-white transition-colors duration-200 hover:bg-blue-700"
            >
              Contact Us
            </TransitionLink>
          </div>
